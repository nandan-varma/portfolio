...
url: https://www.npmjs.com/package/@calendar-sdk/core
published: true
---
...
- **A mock provider as a first-class package, not a test fixture** - shipping the mock as `@calendar-sdk/mock` means examples and quickstarts can run with zero credentials and zero network calls, which matters a lot for anyone evaluating the SDK before wiring up real OAuth
