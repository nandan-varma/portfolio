...
tried running it on the edge/serverless, ran into too many issues
wrote and published couple of npm packages along the way to make it work
Debugged a lot of performance issues
In the end, Got a really good workflow similar to GitHub

Read more: https://www.nandan.fyi/blog/pushstack

Here is a link to that github tracker if you want to go down that rabbit hole yourself: https://mrshu.github.io/github-statuses/
