...
description: Doesn't matter what, just build something.
date: "2025-06-26"
draft: true
...
So I thought I would write down my thoughts on this and I will refrain from giving you same advice you see everywhere else.
...
**Use it to help you write code, to generate ideas, to find bugs, and to learn new things.**
But don't use it to write your entire application or to solve all your problems.

And most important of them all, use the right tool for the job.

Here are some AI tools I use:
- [V0.dev](https://v0.dev) for creating simple web application prototypes.
- [Database.build](https://database.build) for creating SQL migrations and visualizing database schema.
...
Everyday I open [GitHub Trending](https://github.com/trending) to see what's new and how it works, how it is built, and what technologies are used.
...
Heck you can even reachout to them and ask questions, most of the time they will be happy to help you.
...
And please don't buy courses/certifications with absurd promises. Ask around if it is worth it.
...
That includes pasting code from chatgpt window to vscode and calling it a day.
...
If you dont have access to a good computer or cant install software on college computers, don't worry.
Most of the development can just be used from the browser through cloud without any setup using tools like:
