#!/usr/bin/env node
// Uploads arbitrary files to UploadThing and prints the public URL for each.
// Usage: node scripts/upload-file.mjs <file1> [file2 ...]
...
const mimeTypes = { ".pdf": "application/pdf" };
...
if (files.length === 0) {
	console.error("Usage: node scripts/upload-file.mjs <file1> [file2 ...]");
	process.exit(1);
}
